...
import { Settings, Bell, Heart, LogOut, Wrench, X, Lock, Megaphone, User, LogIn, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="bg-white min-h-full flex flex-col items-center justify-center p-8">
        ...
        */}
        <button
          ...
          className="mt-12 text-gray-300 text-xs font-bold flex items-center hover:text-brand-500 transition-colors"
        >
